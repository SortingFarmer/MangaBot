...
module.exports = {
    ...
    async execute(interaction) {
        ...
        fields.push({
            name: `**Users**`,
            value: `There are ${users.length} registered users, of which ${users.filter(user => user.banned).length} are banned.`,
            inline: true
        });
        ...
        fields.push({
            name: `**Uptime**`,
            value: `I have been online for ${(interaction.client.uptime / 1000 / 60).toFixed(2)} minutes.`,
            inline: true
        });
